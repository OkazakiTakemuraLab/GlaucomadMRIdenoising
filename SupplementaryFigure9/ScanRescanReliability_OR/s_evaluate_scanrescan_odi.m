...
% This script aims to replicate bottom panels in Supplementaly Figure 9 of the following
% article:
...
% Plot x=y line
plot([0.1 0.3], [0.1 0.3], '--k', 'LineWidth', 1.5); % x=y line
...
set(gca, 'tickdir', 'out', ...
    'box', 'off', ...
    'ylim', [0.1 0.3], 'ytick', [0.1 0.2 0.3], ...
    'xlim', [0.1 0.3], 'xtick', [0.1 0.2 0.3], 'fontsize',15);
