...
% This script aims to replicate top panels in Supplementaly Figure 9 of the following
% article:
...
% Plot x=y line
plot([0.4 0.8], [0.4 0.8], '--k', 'LineWidth', 1.5);
...
set(gca, 'tickdir', 'out', ...
    'box', 'off', ...
    'ylim', [0.4 0.8], 'ytick', [0.4 0.6 0.8], ...
    'xlim', [0.4 0.8], 'xtick', [0.4 0.6 0.8], 'fontsize',15);
...
ylabel('Run 2 (PA)','fontsize',18);
xlabel('Run 1 (AP)','fontsize',18);
titletext = ['R = ', num2str(r_corr_eff_P2S, '%.2f')];
text((M-m)*0.62+m, (M-m)*0.07+m, titletext, 'fontsize', 18);
