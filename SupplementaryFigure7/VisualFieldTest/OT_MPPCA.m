...
% This script aims to replicate  panels in Supplementaly Figure 7B of the following
% article:
...
for k = 1:47
    if k < 31
    fa_1_control_lh(:,k) = (all_profile.fa1_MPPCA(11:90,k) + all_profile.fa2_MPPCA(11:90,k))./2;    
    md_1_control_lh(:,k) = (all_profile.md1_MPPCA(11:90,k) + all_profile.md2_MPPCA(11:90,k))./2;
    icvf_1_control_lh(:,k) = (all_profile.icvf_1_MPPCA(11:90,k) + all_profile.icvf_2_MPPCA(11:90,k))./2;    
    odi_1_control_lh(:,k) = (all_profile.odi_1_MPPCA(11:90,k) + all_profile.odi_2_MPPCA(11:90,k))./2;
    else
    fa_1_glaucoma_lh(:,k-30) = (all_profile.fa1_MPPCA(11:90,k) + all_profile.fa2_MPPCA(11:90,k))./2;    
    md_1_glaucoma_lh(:,k-30) = (all_profile.md1_MPPCA(11:90,k) + all_profile.md2_MPPCA(11:90,k))./2;
    icvf_1_glaucoma_lh(:,k-30) = (all_profile.icvf_1_MPPCA(11:90,k) + all_profile.icvf_2_MPPCA(11:90,k))./2;
    odi_1_glaucoma_lh(:,k-30) = (all_profile.odi_1_MPPCA(11:90,k) + all_profile.odi_2_MPPCA(11:90,k))./2;
    end
end
...
for k = 1:47
    if k < 31
    fa_1_control_rh(:,k) = (all_profile.fa1_MPPCA(11:90,k) + all_profile.fa2_MPPCA(11:90,k))./2;    
    md_1_control_rh(:,k) = (all_profile.md1_MPPCA(11:90,k) + all_profile.md2_MPPCA(11:90,k))./2;
    icvf_1_control_rh(:,k) = (all_profile.icvf_1_MPPCA(11:90,k) + all_profile.icvf_2_MPPCA(11:90,k))./2;    
    odi_1_control_rh(:,k) = (all_profile.odi_1_MPPCA(11:90,k) + all_profile.odi_2_MPPCA(11:90,k))./2;
    else
    fa_1_glaucoma_rh(:,k-30) = (all_profile.fa1_MPPCA(11:90,k) + all_profile.fa2_MPPCA(11:90,k))./2;    
    md_1_glaucoma_rh(:,k-30) = (all_profile.md1_MPPCA(11:90,k) + all_profile.md2_MPPCA(11:90,k))./2;
    icvf_1_glaucoma_rh(:,k-30) = (all_profile.icvf_1_MPPCA(11:90,k) + all_profile.icvf_2_MPPCA(11:90,k))./2;
    odi_1_glaucoma_rh(:,k-30) = (all_profile.odi_1_MPPCA(11:90,k) + all_profile.odi_2_MPPCA(11:90,k))./2;
    end
end
...
for m = 1:4
    ...
    patch([xfig fliplr(xfig)], [yDown fliplr(yUp)], ...
          [0.92 0.6 0.7], 'EdgeColor','none', 'FaceAlpha',0.4)
    ...
    sgtitle('With MPPCA','FontSize',22,'FontWeight','bold');
end
print(gcf, 'VFT_OT_MPPCA.eps', '-depsc', '-painters');
end