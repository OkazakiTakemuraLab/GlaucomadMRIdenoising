...
for k = 1:47
    if k < 31
    fa_1_control_lh(:,k) = (all_profile.fa1_P2S(11:90,k) + all_profile.fa2_P2S(11:90,k))./2;    
    md_1_control_lh(:,k) = (all_profile.md1_P2S(11:90,k) + all_profile.md2_P2S(11:90,k))./2;
    icvf_1_control_lh(:,k) = (all_profile.icvf_1_P2S(11:90,k) + all_profile.icvf_2_P2S(11:90,k))./2;    
    odi_1_control_lh(:,k) = (all_profile.odi_1_P2S(11:90,k) + all_profile.odi_2_P2S(11:90,k))./2;
    else
    fa_1_glaucoma_lh(:,k-30) = (all_profile.fa1_P2S(11:90,k) + all_profile.fa2_P2S(11:90,k))./2;    
    md_1_glaucoma_lh(:,k-30) = (all_profile.md1_P2S(11:90,k) + all_profile.md2_P2S(11:90,k))./2;
    icvf_1_glaucoma_lh(:,k-30) = (all_profile.icvf_1_P2S(11:90,k) + all_profile.icvf_2_P2S(11:90,k))./2;
    odi_1_glaucoma_lh(:,k-30) = (all_profile.odi_1_P2S(11:90,k) + all_profile.odi_2_P2S(11:90,k))./2;
    end
end
...
for k = 1:47
    if k < 31
    fa_1_control_rh(:,k) = (all_profile.fa1_P2S(11:90,k) + all_profile.fa2_P2S(11:90,k))./2;    
    md_1_control_rh(:,k) = (all_profile.md1_P2S(11:90,k) + all_profile.md2_P2S(11:90,k))./2;
    icvf_1_control_rh(:,k) = (all_profile.icvf_1_P2S(11:90,k) + all_profile.icvf_2_P2S(11:90,k))./2;    
    odi_1_control_rh(:,k) = (all_profile.odi_1_P2S(11:90,k) + all_profile.odi_2_P2S(11:90,k))./2;
    else
    fa_1_glaucoma_rh(:,k-30) = (all_profile.fa1_P2S(11:90,k) + all_profile.fa2_P2S(11:90,k))./2;    
    md_1_glaucoma_rh(:,k-30) = (all_profile.md1_P2S(11:90,k) + all_profile.md2_P2S(11:90,k))./2;
    icvf_1_glaucoma_rh(:,k-30) = (all_profile.icvf_1_P2S(11:90,k) + all_profile.icvf_2_P2S(11:90,k))./2;
    odi_1_glaucoma_rh(:,k-30) = (all_profile.odi_1_P2S(11:90,k) + all_profile.odi_2_P2S(11:90,k))./2;
    end
end
...
for m = 1:4
    ...
    patch([xfig fliplr(xfig)], [yDown fliplr(yUp)], ...
          [0.66 0.2 0.55], 'EdgeColor','none', 'FaceAlpha',0.4)
    ...
    sgtitle('With Patch2Self','FontSize',22,'FontWeight','bold');
end
print(gcf, 'VFT_OT_P2S.eps', '-depsc', '-painters');
end