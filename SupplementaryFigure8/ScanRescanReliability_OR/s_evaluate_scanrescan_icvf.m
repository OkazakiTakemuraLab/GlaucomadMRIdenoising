...
% This script aims to replicate third panels in Supplementaly Figure 8 of the following
% article:
...
% Plot x=y line
plot([0.4 0.7], [0.4 0.7], '--k', 'LineWidth', 1.5);
...
set(gca, 'tickdir', 'out', ...
    'box', 'off', ...
    'ylim', [0.4 0.7], 'ytick', [0.4 0.5 0.6 0.7], ...
    'xlim', [0.4 0.7], 'xtick', [0.4 0.5 0.6 0.7], 'fontsize',15);
