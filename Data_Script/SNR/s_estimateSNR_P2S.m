...
for i = 1:length(subjDir)
    ...
    dwi_dwidenoise_AP = niftiRead(fullfile(baseDir,subjDir{i}, 'dwi','preprocessed_AP_P2S','dwi_AP','dwi_AP_eddy_unwarped_images_aligned_trilin_noMEC.nii.gz'));
    dwi_dwidenoise_PA = niftiRead(fullfile(baseDir,subjDir{i}, 'dwi','preprocessed_PA_P2S','dwi_PA','dwi_PA_eddy_unwarped_images_aligned_trilin_noMEC.nii.gz'));
    ...
    bval_dwidenoise_AP = dlmread(fullfile(baseDir,subjDir{i}, 'dwi','preprocessed_AP_P2S','dwi_AP','dwi_AP_eddy_unwarped_images_aligned_trilin_noMEC.bvals'));
    bval_dwidenoise_PA = dlmread(fullfile(baseDir,subjDir{i}, 'dwi','preprocessed_PA_P2S','dwi_PA','dwi_PA_eddy_unwarped_images_aligned_trilin_noMEC.bvals'));
...
savefilename = 'b0SNR_estimate_P2S.mat';
