...
% This script aims to replicate panel B in Supplementaly Figure 3 of the following
% article:
...
load ../../Data/FittingAcuracy/OR/LOR_RicianLL_NODDI.mat
x = (all_RicianLL.RicianLL1_wo + all_RicianLL.RicianLL2_wo)/2;
y = (all_RicianLL.RicianLL1_MPPCA + all_RicianLL.RicianLL2_MPPCA)/2;
z = (all_RicianLL.RicianLL1_P2S + all_RicianLL.RicianLL2_P2S)/2;
%% Load right optic radiation data, compute combined averages
load ../../Data/FittingAcuracy/OR/ROR_RicianLL_NODDI.mat
...
set(gca, 'xtick', 1:3, 'xticklabel', {'Without Denoising', 'With MPPCA', 'With P2S'}, ...
    'ytick', [-480 -460 -440 -420 -400 -380 -360 -340], 'fontsize',15);
...
box on;
print(gcf, 'RicianLL_NODDI_OR.eps', '-depsc', '-painters');
hold off;
